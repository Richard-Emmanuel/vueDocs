...
import { A as AstroError, U as UnknownContentCollectionError, c as createComponent, k as RenderUndefinedEntryError, u as unescapeHTML, b as renderTemplate, l as renderUniqueStylesheet, n as renderScriptElement, p as createHeadAndContent, r as renderComponent, a as AstroUserError } from './astro/server_BMW5zgxf.mjs';
import 'kleur/colors';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_CxOPZzvG.mjs');
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_Bm952Vfk.mjs').then(n => n._);
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import('./content-modules_DNjLQ0t1.mjs');
...
const starlightConfig = {"logo":{"src":"./src/assets/images/vue-logo.png","alt":"","replacesTitle":false},"social":[{"icon":"github","label":"GitHub","href":"https://github.com/withastro/starlight"}],"tableOfContents":{"minHeadingLevel":2,"maxHeadingLevel":3},"editLink":{},"sidebar":[{"label":"Getting Started","translations":{},"collapsed":false,"items":[{"label":"Introduction","translations":{},"slug":"getting-started/introduction","attrs":{}},{"label":"Quick start","translations":{},"slug":"getting-started/quick-start","attrs":{}}]},{"label":"Essentials","translations":{},"collapsed":false,"items":[{"label":"Creating an Application","translations":{},"slug":"essentials/creating-an-application","attrs":{}},{"label":"Template Syntax","translations":{},"slug":"essentials/template-syntax","attrs":{}},{"label":"Reactivity Fundamentals","translations":{},"slug":"essentials/reactivity-fundamentals","attrs":{}},{"label":"Computed Properties","translations":{},"slug":"essentials/computed-properties","attrs":{}},{"label":"Class and Style Bindings","translations":{},"slug":"essentials/class-and-style-bindings","attrs":{}}]},{"label":"Components In-Depth","translations":{},"collapsed":false,"items":[{"label":"Registration","translations":{},"slug":"components-in-depth/registration","attrs":{}},{"label":"Props","translations":{},"slug":"components-in-depth/props","attrs":{}},{"label":"Events","translations":{},"slug":"components-in-depth/events","attrs":{}},{"label":"Component v-model","translations":{},"slug":"components-in-depth/component-v-model","attrs":{}},{"label":"Fallthrough Attributes","translations":{},"slug":"components-in-depth/fallthrough-attributes","attrs":{}}]},{"label":"Reusability","translations":{},"collapsed":false,"items":[{"label":"Composables","translations":{},"slug":"reusability/composables","attrs":{}},{"label":"Custom Directives","translations":{},"slug":"reusability/custom-directives","attrs":{}},{"label":"Plugins","translations":{},"slug":"reusability/plugins","attrs":{}}]},{"label":"Built-In Components","translations":{},"collapsed":false,"items":[{"label":"Transition","translations":{},"slug":"built-in-components/transition","attrs":{}},{"label":"TransitionGroup","translations":{},"slug":"built-in-components/transition-group","attrs":{}},{"label":"KeepAlive","translations":{},"slug":"built-in-components/keep-alive","attrs":{}},{"label":"Teleport","translations":{},"slug":"built-in-components/teleport","attrs":{}},{"label":"Suspense","translations":{},"slug":"built-in-components/suspense","attrs":{}}]},{"label":"Scaling Up","translations":{},"collapsed":false,"items":[{"label":"Single-File Components","translations":{},"slug":"scaling-up/single-file-components","attrs":{}},{"label":"Tooling","translations":{},"slug":"scaling-up/tooling","attrs":{}},{"label":"Routing","translations":{},"slug":"scaling-up/routing","attrs":{}},{"label":"State Management","translations":{},"slug":"scaling-up/state-management","attrs":{}},{"label":"Testing","translations":{},"slug":"scaling-up/testing","attrs":{}},{"label":"Server-Side Rendering (SSR)","translations":{},"slug":"scaling-up/server-side-rendering","attrs":{}}]},{"label":"Best Practices","translations":{},"collapsed":false,"items":[{"label":"Product Deployment","translations":{},"slug":"best-practices/product-deployment","attrs":{}},{"label":"Performance","translations":{},"slug":"best-practices/performance","attrs":{}},{"label":"Accessibility","translations":{},"slug":"best-practices/accessibility","attrs":{}},{"label":"Security","translations":{},"slug":"best-practices/security","attrs":{}}]},{"label":"Typescript","translations":{},"collapsed":false,"items":[{"label":"Overview","translations":{},"slug":"typescript/overview","attrs":{}},{"label":"TS with Composition API","translations":{},"slug":"typescript/ts-with-composition-api","attrs":{}},{"label":"TS with Options API","translations":{},"slug":"typescript/ts-with-options-api","attrs":{}}]},{"label":"Extra Topics","translations":{},"collapsed":false,"items":[{"label":"Ways of Using Vue","translations":{},"slug":"extra-topics/ways-of-using-vue","attrs":{}},{"label":"Composition API FAQ","translations":{},"slug":"extra-topics/composition-api-faq","attrs":{}},{"label":"Reactivity in Depth","translations":{},"slug":"extra-topics/reactivity-in-depth","attrs":{}},{"label":"Rendering Mechanism","translations":{},"slug":"extra-topics/rendering-mechanism","attrs":{}},{"label":"Render Functions & JSX","translations":{},"slug":"extra-topics/render-functions-jsx","attrs":{}}]},{"label":"Reference","translations":{},"collapsed":false,"autogenerate":{"directory":"reference"}}],"head":[],"lastUpdated":false,"pagination":true,"favicon":{"href":"./src/assets/images/favicon.svg","type":"image/svg+xml"},"components":{"Search":"@astrojs/starlight/components/Search.astro"},"titleDelimiter":"|","credits":false,"pagefind":{"ranking":{"pageLength":0.1,"termFrequency":0.1,"termSaturation":2,"termSimilarity":9}},"title":{"en":"Vue.js"},"isMultilingual":false,"defaultLocale":{"label":"English","lang":"en","dir":"ltr"}};

const project = {"build":{"format":"directory"},"root":"file:///C:/Users/Admin/Desktop/Project/vue-docs/","srcDir":"file:///C:/Users/Admin/Desktop/Project/vue-docs/src/","trailingSlash":"ignore"};
...
export { BuiltInDefaultLocale as B, DEFAULT_OUTPUT_FORMAT as D, VALID_SUPPORTED_FORMATS as V, stripTrailingSlash as a, stripLeadingSlash as b, stripHtmlExtension as c, ensureTrailingSlash as d, ensureHtmlExtension as e, getCollectionPathFromRoot as f, getCollection as g, pickLang as h, stripLeadingAndTrailingSlashes as i, ensureLeadingSlash as j, stripExtension as k, getEntry as l, getCollectionPath as m, DEFAULT_HASH_PROPS as n, project as p, renderEntry as r, starlightConfig as s, useTranslations as u };
